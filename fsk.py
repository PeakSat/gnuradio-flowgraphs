...
class fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, baudrate=50e3, rx_freq=435e6, rx_gain=30.0, samp_rate=2e6, sps_rx=4, sps_tx=16, tx_freq=435e6, tx_gain=60.0, zmq_pub_uri='tcp://127.0.0.1:55000', zmq_sub_uri='tcp://127.0.0.1:55001'):
